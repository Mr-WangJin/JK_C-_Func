...
#ifndef __JK_VECTOR_HPP_INCLUDED__
#define __JK_VECTOR_HPP_INCLUDED__
...
class vector : public std::vector<T> {
 public:
	...
	T& operator [] (size_type index) {
		JK_TEST_ASSERT(index < std::vector<T>::size(),
...
template <typename T>
inline
std::ostream& operator << (std::ostream& os, const jk::vector<T>& v) {
...
#endif // __JK_VECTOR_HPP_INCLUDED__